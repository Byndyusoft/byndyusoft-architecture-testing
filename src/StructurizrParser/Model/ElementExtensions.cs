namespace Byndyusoft.ArchitectureTesting.StructurizrParser.Model
{
    ...
    internal static class ElementExtensions
    {
        ...
        public static bool IsStorage(this Element element) => element.HasTag("Storage");
        ...
        public static bool IsMsSql(this Element element)
            => element.IsStorage() && string.Equals(element.GetTechnology(), "MSSQL", StringComparison.InvariantCultureIgnoreCase);

        public static bool IsPostgreSql(this Element element)
            => element.IsStorage() && string.Equals(element.GetTechnology(), "PostgreSQL", StringComparison.InvariantCultureIgnoreCase);

        public static bool IsS3(this Element element)
            => element.IsStorage() && string.Equals(element.GetTechnology(), "MinIO", StringComparison.InvariantCultureIgnoreCase);
